...
def is_blackjack(card_one, card_two):
    ...
    if (card_one == "A" and card_two in FACE_CARDS) or (
        card_two == "A" and card_one in FACE_CARDS
    ):
        return True
    ...
    if card_one == "A" and 11 + value_of_card(card_two) == 21:
        return True

    if card_two == "A" and 11 + value_of_card(card_one) == 21:
        return True
